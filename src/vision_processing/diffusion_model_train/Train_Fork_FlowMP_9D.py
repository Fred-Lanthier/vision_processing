...
# ==============================================================================
# 3. ROBUST NORMALIZER (Handles 9D Obs and 9D Actions)
# ==============================================================================

class Normalizer(nn.Module):
    def __init__(self, obs_dim=9, act_dim=9, stats=None):
        super().__init__()
...
class FlowMatchingAgent(nn.Module):
    ...
    def predict_action(self, obs_dict, num_steps=10, method='euler'):
        ...
        # On dénormalise l'action à 9 dimensions
...
def compute_dataset_stats(dataset, obs_dim=9, act_dim=9):
...
def train_flow_matching(
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            save_name = "best_fm_model_9D_dynamics_1024.ckpt"
            print("Saved Best EMA Model")
        else:
            save_name = "last_fm_model_9D_dynamics_1024.ckpt"
...
def main():
    from Data_Loader_Fork_FlowMP_9D import Robot3DDataset, seed_everything
    ...
    config = {
        ...
        "lr": LEARNING_RATE,
        "model_name": "FlowMatching_Fork_9D_Dynamics",
        "obs_dim": OBS_DIM,
    ...
    with open(os.path.join(models_dir, 'fm_results_9D.json'), 'w') as f:
