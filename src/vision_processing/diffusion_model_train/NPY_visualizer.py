...
def quick_3d_view(depth_image_path, filter_percentile=0):
    ...
    ax.set_ylim([-0.4, 0.4])
    ax.set_zlim([0, 0.8])
    ax.view_init(elev=20, azim=70) # Set view angle (elevation, azimuth)
...
def main():
    ...
    depth_image_path = f"{base_path}/Trajectories_preprocess/Trajectory_20/Merged_pcd_Trajectory_20/Merged_0050.npy"
