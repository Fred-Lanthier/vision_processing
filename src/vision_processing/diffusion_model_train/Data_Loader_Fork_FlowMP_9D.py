...
class Robot3DDataset(Dataset):
    def __init__(self, 
        ...
        for folder in tqdm(self.traj_folders, desc="Processing Data"):
            ...
            for current_idx in range(self.obs_horizon - 1, total_steps - self.pred_horizon + 1):
                ...
                # D. Concaténation de l'action à 9 dimensions
                ...
                self.processed_data.append({
                    ...
                    'act': action_full,              # (pred_horizon, 9)
                })
    ...
    def _apply_augmentation(self, pcd, obs_poses, action_seq):
        """
        Augmentation adaptée pour les tenseurs d'action à 9D.
        """
        ...
        # Rotation de l'action (9D)
        for i in range(0, 9, 3):  # Applique la rotation par blocs de 3 dimensions
