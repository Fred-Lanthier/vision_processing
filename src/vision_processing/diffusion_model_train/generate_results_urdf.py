...
def generate_train_history():
    ...
    pkl_file = os.path.join(package_path, 'pkl_files', 'train_history_urdf_FPS_fork_SAMPLE.pkl')
...
def main():
    ...
    ckpt_path = os.path.join(pkg_path, "models", "dp3_policy_last_robust_urdf_FPS_fork_SAMPLE.ckpt") 
